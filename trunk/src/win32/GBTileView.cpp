...
void GBTileView::saveBMP(LPCTSTR name)
{
...
void GBTileView::savePNG(LPCTSTR name)
{
  u8 writeBuffer[1024 * 3];
...
BOOL GBTileView::OnInitDialog()
{
  ...
  DIALOG_SIZER_START( sz )
    ...
    SetData(sz,
            TRUE,
            HKEY_CURRENT_USER,
            _T("Software\\Emulators\\VisualBoyAdvance\\Viewer\\GBTileView"),
            NULL);
